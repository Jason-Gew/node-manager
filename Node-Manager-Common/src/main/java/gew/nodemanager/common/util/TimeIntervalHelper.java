...
public class TimeIntervalHelper {
    ...
    public static Long toMilliSeconds(long time, final TimeUnit unit) {
        long result;
        if (unit == null) {
            throw new IllegalArgumentException("Invalid Time Unit");
        }
    ...
    public static TimeUnit toTimeUnit(final String unit) {
        if (unit == null) {
            throw new IllegalArgumentException("Invalid Time Unit");
        }
        switch (unit.toLowerCase().trim()) {
    ...
    public static ChronoUnit toTemporalUnit(final String unit) {
        if (unit == null) {
            return null;
        }
        switch (unit.toLowerCase().trim()) {
    ...
    public static Duration toDuration(long value, ChronoUnit unit) {
        if (unit == null) {
            throw new IllegalArgumentException("Invalid TemporalUnit");
        }
        switch (unit) {
            case DAYS:
